...
public class Constants {
	...
	public final static int CLOUDLET_LENGTH = 250000;	// 600000 / 1000 = 600 seconds =10 Min simulation
	...
	*/
	...
	public final static IoWorkloadModel ioWorkload1 = new IoWorkloadModel("seq_read_dominant", 1, 0, 1024, 1000, 32300);
	public final static boolean REAL_IO = true;
	public final static String INPUT_IO_WORKLOAD_DIR = "/home/hamza/workspace/vmStorageOptim/examples/workload/io/ssd/8vm_per_host";
	...
	*/
	...
	public final static int HOST_TYPES = 3;
	public final static int[] HOST_MIPS = { 2000, 2000, 2000 };
	public final static int[] HOST_PES = { 1, 1, 1 };
	public final static int[] HOST_RAM = { 2048, 2048, 2048};
	public final static int HOST_BW = 1000000; // 1 Gbit/s
	public final static int HOST_STORAGE = 1000000; // 1 TB
	/*
