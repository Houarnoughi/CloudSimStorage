...
public class IoHelper {
	 ...
	 * @return the list< vm>
	 */
	public static List<IoVm> createVmList(int brokerId, int vmsNumber, String workloadInputFolder, String workload) {
		...
		for (int i = 0; i < vmsNumber; i++) {
			...
			if (IoConstants.REAL_IO) {
				try {
					File inputFolder = new File(workloadInputFolder + "/ssd/" + workload);
