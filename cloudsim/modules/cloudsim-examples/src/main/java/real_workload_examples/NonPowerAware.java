...
public class NonPowerAware {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			List<Cloudlet> cloudletList = RealWorkloadHelper
					.createCloudletListRealWorkload(brokerId, inputFolder);
			List<IoVm> vmList = Helper
					.createVmList(brokerId, cloudletList.size());
			List<IoHost> hostList = Helper
					.createHostList(RealWorkloadConstants.NUMBER_OF_HOSTS);

			IoDataCenter datacenter = (IoDataCenter) Helper
