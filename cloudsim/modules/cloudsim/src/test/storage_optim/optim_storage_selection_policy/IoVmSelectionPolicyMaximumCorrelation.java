 ...
 */
public class IoVmSelectionPolicyMaximumCorrelation extends IoVmSelectionPolicy {

	/** The fallback policy. */
	private IoVmSelectionPolicy fallbackPolicy;
	 ...
	 */
	public IoVmSelectionPolicyMaximumCorrelation(final IoVmSelectionPolicy fallbackPolicy) {
		super();
	 ...
	 */
	@Override
	public Vm getVmToMigrate(final IoHost host) {
	 ...
	 */
	protected double[][] getUtilizationMatrix(final List<IoVm> vmList) {
		int n = vmList.size();
	 ...
	 */
	protected int getMinUtilizationHistorySize(final List<IoVm> vmList) {
	 ...
	 */
	public IoVmSelectionPolicy getFallbackPolicy() {
	 ...
	 */
	public void setFallbackPolicy(final IoVmSelectionPolicy fallbackPolicy) {
