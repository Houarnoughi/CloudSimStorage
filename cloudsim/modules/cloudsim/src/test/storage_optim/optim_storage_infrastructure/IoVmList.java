 ...
 */
public class IoVmList extends VmList {
	 ...
	 */
	public static <T extends Vm> void sortByRndWrtRatio(List<T> vmList) {
		Collections.sort(vmList, new Comparator<T>() {
			...
			public int compare(T a, T b) throws ClassCastException {
				IoVm vm1 = (IoVm) a;
				IoVm vm2 = (IoVm) b;
				Double aRatio = vm1.getIoWorkloadModel().getRandomRate(CloudSim.clock())/(1-vm1.getIoWorkloadModel().getReadRate(CloudSim.clock()));
				Double bRatio = vm2.getIoWorkloadModel().getRandomRate(CloudSim.clock())/(1-vm2.getIoWorkloadModel().getReadRate(CloudSim.clock()));
