 ...
 */
public abstract class IoVmAllocationPolicyMigrationAbstract extends IoVmAllocationPolicyAbstract {

	/** The vm selection policy. */
	private IoVmSelectionPolicy vmSelectionPolicy;
	 ...
	 */
	public IoVmAllocationPolicyMigrationAbstract(
	 ...
	 * @param overUtilizedHosts the over utilized hosts
	 */
	protected void printOverUtilizedHosts(List<IoHost> overUtilizedHosts) {
		if (!Log.isDisabled()) {
	 ...
	 */
	protected boolean isHostOverUtilizedAfterAllocation(IoHost host, Vm vm) {
	 ...
	 */
	@Override
	public IoHost findHostForVm(Vm vm) {
	 ...
	 * @return the list
	 */
	protected List<IoHost> extractHostListFromMigrationMap(List<Map<String, Object>> migrationMap) {
		List<IoHost> hosts = new LinkedList<IoHost>();
		for (Map<String, Object> map : migrationMap) {
			hosts.add((IoHost) map.get("host"));
		}
		return hosts;
	}
	 ...
	 */
	protected List<? extends Vm> getVmsToMigrateFromUnderUtilizedHost(IoHost host) {
		List<Vm> vmsToMigrate = new LinkedList<Vm>();
	 ...
	 */
	protected List<IoHost> getSwitchedOffHosts() {
		List<IoHost> switchedOffHosts = new LinkedList<IoHost>();
		for (IoHost host : this.<IoHost> getHostList()) {
	 ...
	 */
	protected boolean areAllVmsMigratingOutOrAnyVmMigratingIn(IoHost host) {
	 ...
	 */
	protected abstract boolean isHostOverUtilized(IoHost host);
	 ...
	 * @return the power after allocation
	 */
	protected double getMaxUtilizationAfterAllocation(IoHost host, Vm vm) {
	 ...
	 */
	protected void setVmSelectionPolicy(IoVmSelectionPolicy vmSelectionPolicy) {
