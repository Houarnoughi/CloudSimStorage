...
public interface Storage {
	 ...
	 * file can also be found using {@link gridsim.datagrid.MyFile#getTransactionTime()}.
	 * 
	 ...
	 * can be found using {@link gridsim.datagrid.MyFile#getTransactionTime()}.
	 * 
	...
	/**
	 * Removes a file from the storage. The time taken (in seconds) for deleting the specified file
	 * can also be found using {@link gridsim.datagrid.MyFile#getTransactionTime()}.
	 * 
	 * @param fileName the name of the file to be removed
	...
	/**
	 * Gets the UID of the storage device
	 * @return
	 */
	String getUid();
	
	/**
	 * Sets the UID of the storage device
	 * @param deviceUid
	 */
	void setUid(String deviceUid);
	/**
	 * Gets the max IOPS offered by the device
	 * @return
	 */
	int getMaxIops();
