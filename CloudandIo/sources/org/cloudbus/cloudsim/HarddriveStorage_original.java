 ...
 */
public class HarddriveStorage_original implements Storage_original {
	 ...
	 */
	public HarddriveStorage_original(String name, double capacity) throws ParameterException {
	 ...
	 */
	public HarddriveStorage_original(double capacity) throws ParameterException {
		if (capacity <= 0) {
			throw new ParameterException("HarddriveStorage(): Error - capacity <= 0.");
		}
