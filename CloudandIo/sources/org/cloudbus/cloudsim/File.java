...
public class File {
	 ...
	 * @return <tt>true</tt> if successful, <tt>false</tt> otherwise
	 * @see Storage_original.datagrid.storage.Storage#addFile(File)
	 * @see Storage_original.datagrid.storage.Storage#addFile(List)
	 * @see Storage_original.datagrid.storage.Storage#addReservedFile(File)
	 * @see Storage_original.datagrid.storage.Storage#deleteFile(File)
	 * @see Storage_original.datagrid.storage.Storage#deleteFile(String)
	 * @see Storage_original.datagrid.storage.Storage#deleteFile(String, File)
	 * @see Storage_original.datagrid.storage.Storage#getFile(String)
	 * @see Storage_original.datagrid.storage.Storage#renameFile(File, String)
	 */
