...
import io_storage.BcomStorageCostModel;
 ...
 */
public class IoVmAllocationPolicyMinStorageCost extends IoVmAllocationPolicyMigrationAbstract {
	 ...
	 * @param list the list
	 */
	public IoVmAllocationPolicyMinStorageCost(List<? extends Host> hostList,
			IoVmSelectionPolicy vmSelectionPolicy, double utilization) {
		super(hostList, vmSelectionPolicy);
		setUtilizationThreshold(utilization);
	}
			...
			if (host.isSuitableForVm(vm)) {
				...
				for (Storage device: host.getStorageDevices()) {
					if (device != null) {
						...
						Log.printLine(" HEEEERE COST is "+ costAfterAllocation);
