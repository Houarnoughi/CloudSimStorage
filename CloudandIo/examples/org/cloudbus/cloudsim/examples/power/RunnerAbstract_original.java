 ...
 */
public abstract class RunnerAbstract_original {
	 ...
	 */
	public RunnerAbstract_original(
	...
	protected void start(String experimentName, String outputFolder, VmAllocationPolicy vmAllocationPolicy) {
		...
		try {
			PowerDatacenter datacenter = (PowerDatacenter) Helper_original.createDatacenter(
					"Datacenter",
	...
	public void setEnableOutput(boolean enableOutput) {
		RunnerAbstract_original.enableOutput = enableOutput;
	}
